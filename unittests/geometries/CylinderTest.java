...
class CylinderTest {
    ...
    void getNormal() {
        ...
        assertEquals(new Vector(1, 0, 0),cyln.getNormal(new Point(0, 0, 2)), "getNormal is not working - BVA3: First base");

        //BVA4: Second base - perimeter
        assertEquals(new Vector(1, 0, 0),cyln.getNormal(new Point(10, 0, 2)), "getNormal is not working - BVA4: Second base");
