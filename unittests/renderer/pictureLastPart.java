...
public class pictureLastPart {
    ...
    void myPictureLastPart() {
        ...
        Camera camera = new Camera(new Point(0, -500, 10), new Vector(0, 1, 0), new Vector(0, 0, 1));
        camera.setVPSize(150, 150).setVPDistance(100);

        Material material = new Material().setKd(0.4).setKs(1).setnShininess(50).setKt(0).setKr(0.5);
        ...
        PointLight pointLight = new PointLight(new Color(255,255,255),new Point(0,-100,0));
        ...
        Polygon sqr1 = new Polygon(new Point(-100, 200, -100), new Point(-100, 200, 100), new Point(100, 200, 100), new Point(100, 200, -100));
        sqr1.setMaterial(material);//.setEmission(new Color(255, 215, 0));

        Polygon sqrt2 = new Polygon(new Point(-200, 100, -100), new Point(-200, 100, 100), new Point(-200, -100, 100), new Point(-200, -100, -100));
        sqrt2.setMaterial(material);//.setEmission(new Color(0, 0, 0));

        Polygon sqrt3 = new Polygon(new Point(200, -100, -100), new Point(200, -100, 100), new Point(200, 100, 100), new Point(200, 100, -100));
        sqrt3.setMaterial(material);//.setEmission(new Color(0, 0, 0));

        Polygon sqrt4 = new Polygon(new Point(100, -100, 200), new Point(-100, -100, 200), new Point(-100, 100, 200), new Point(100, 100, 200));
        sqrt4.setMaterial(material);//.setEmission(new Color(0, 0, 0));

        Polygon sqrt5 = new Polygon(new Point(100, -100, -200), new Point(-100, -100, -200), new Point(-100, 100, -200), new Point(100, 100, -200));
        sqrt5.setMaterial(material);//.setEmission(new Color(0, 0, 0));

        scene.geometries.add(sqr1, sqrt2, sqrt3, sqrt4, sqrt5, sphere);
